                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Enter Product Name" wire:model="name">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" min="1" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput2" wire:model="amount"
                        ...
                        <div class="mb-4">
                            ...
                            @error('product_upc') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="file" accept="image/*"
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput3" wire:model="image"
                                placeholder="Enter UPC No">
